...
export const CreateSingleReview = createAsyncThunk(
  ...
  async (ReviewsData, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.post(`/api/v1/review`, ReviewsData, config);
...
export const getTopRatedReviews = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`/api/v1/review/rated`, config);
...
export const getReviewsStats = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`/api/v1/review/stats`, config);
      return data.stats;
    } catch (error) {
      return thunkAPI.rejectWithValue(
        error.response && error.response.data.message
